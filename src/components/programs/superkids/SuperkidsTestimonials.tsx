...
const testimonials: Testimonial[] = [
  ...
  {
    name: 'Chị Thu Hà',
    context: 'PH bé học Tiểu học (7 tuổi)',
    quote:
  ...
  {
    name: 'Anh Thành Long',
    context: 'PH bé học Tiểu học (9 tuổi)',
    quote:
...
export default function SuperkidsTestimonials() {
  return (
      ...
      <div className="container-page relative">
        ...
        <div className="flex flex-col items-start gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <p className="max-w-sm font-body text-base leading-relaxed text-ink-600 lg:text-right">
            Những chia sẻ thật từ ba mẹ có con đang học Tiểu học tại ILE.
          </p>
        </div>
